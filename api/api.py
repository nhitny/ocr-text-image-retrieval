...
# app = Flask(__name__)
# from api.routers.search_any import search_any_bp
# app.register_blueprint(search_any_bp)
...
from .routers.search_any import search_any_bp
app.register_blueprint(search_any_bp)
...
if __name__ == "__main__":
    # chạy như module hoặc đặt PYTHONPATH=.
    app.run(host="0.0.0.0", port=PORT, debug=True)
